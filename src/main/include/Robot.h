...
#include "Commands/Autonomous/AutoDriveChallenge.h"
...
static std::shared_ptr<ControlPanel> controlPanel;
static std::shared_ptr<Shooter> shooter;
static std::shared_ptr<Intakes> intakes;
	...
	int dir;
	static int autoMode;
	static int autoStartNum;
	static int autoFinishNum;
};
