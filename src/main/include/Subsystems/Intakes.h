...
Intakes();
	...
	//decrementCellCount: subtracts 1 from the power cell tracker variable
	void decrementCellCount();
	//getCellCount: Returns the number of power cells in the magazine
	int getCellCount();
	//clearCellCount: Sets the cell tracker variable to 0
	void clearCellCount();
