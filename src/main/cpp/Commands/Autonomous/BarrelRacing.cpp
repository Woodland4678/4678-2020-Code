...
void BarrelRacing::Initialize() {
    ...
    path1->addWayPoint(-4.572, 1.524, 90); //2.44, 0, 0 - meters
    path1->addWayPoint(-3.810, 0.762, 180);
    path1->addWayPoint(-3.048, 1.524, 270);
    path1->addWayPoint(-3.819, 2.245, 360);
    path1->addWayPoint(-6.086, 2.289, 360);
    path1->addWayPoint(-6.858, 3.048, 270);
    path1->addWayPoint(-6.096, 3.810, 180);
    path1->addWayPoint(-5.334, 3.048, 90);
    path1->addWayPoint(-7.620, 0.762, 0);
    path1->addWayPoint(-8.382, 1.524, -90);
    path1->addWayPoint(-7.620, 2.286, -180);
    path1->addWayPoint(-1.050, 2.281, -180);
    path1->makePath();
}
