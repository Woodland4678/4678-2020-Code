...
void BouncePath::Initialize() {
    ...
    path2->addWayPoint(-3.810, 0.762, -180); 
    path2->addWayPoint(-4.571, 1.524, -270); 
    ...
    path3->addWayPoint(-5.336, 0.762, -360); 
    path3->addWayPoint(-6.096, 0.762, -360); 
    path3->addWayPoint(-6.858, 1.524, -450); 
