...
shooterMotor1.reset(new WPI_TalonSRX(8));


shooterMotor2.reset(new WPI_TalonSRX(9));


shooterMotor3.reset(new WPI_TalonSRX(10));


shooterMotor4.reset(new WPI_TalonSRX(11));


hoodMotor.reset(new WPI_TalonSRX(12));
