...
middleRoller.reset(new rev::CANSparkMax(13, rev::CANSparkMax::MotorType::kBrushless));


magazine.reset(new rev::CANSparkMax(14, rev::CANSparkMax::MotorType::kBrushless));
...
intakeSolenoid.reset(new frc::Solenoid(0, 3));
AddChild("intakeSolenoid", intakeSolenoid);

leftRoller.reset(new rev::CANSparkMax(15, rev::CANSparkMax::MotorType::kBrushless));


rightRoller.reset(new rev::CANSparkMax(16, rev::CANSparkMax::MotorType::kBrushless));
...
void Intakes::Periodic() {
    ...
    frc::SmartDashboard::PutNumber("Power Cells", m_powerCellCount);
