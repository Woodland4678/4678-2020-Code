...
intakePneumatics.reset(new frc::Solenoid(0, 1));
AddChild("intakePneumatics", intakePneumatics);

leftRoller.reset(new rev::CANSparkMax(9, rev::CANSparkMax::MotorType::kBrushless));


rightRoller.reset(new rev::CANSparkMax(12, rev::CANSparkMax::MotorType::kBrushless));


leftIndexer.reset(new frc::DigitalInput(2));
AddChild("leftIndexer", leftIndexer);

rightIndexer.reset(new frc::DigitalInput(3));
AddChild("rightIndexer", rightIndexer);
